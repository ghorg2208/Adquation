...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('admin/login') }}">Contact</a>
                    </li>
                </ul>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left" style="top: 20%">
                        <p><a class="btn btn-lg btn-primary" href="#" role="button">News Adequation - votre partenaire E-learning</a></p>
                        <p>Société de conseil, formation et audit en management de la qualité, de la sécurité
                            et de l’environnement, spécialisée dans les démarches de progrès et d’amélioration continue des hommes et des organisations,
                            le cabinet Adéquation propose une gamme complète de prestations et intervient dans tout type de structures dans les secteurs de l’industrie et
                            des services ainsi qu’auprès d’institutionnels. En partenariat avec le réseau ARKADE, Adéquation propose également des formations E-Learning sur une
                            plateforme dédiée accessible 7j/7 et 24h/24.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <h2>     Qualité, Sécurité, Environnement, Conseil, Audit, Formation :  Découvrez nos pôles de compétences</h2>
            <div class="col-lg-4">
